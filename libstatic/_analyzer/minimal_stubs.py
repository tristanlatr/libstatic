# Taken from https://github.com/google/pytype/blob/main/pytype/stubs/builtins/README.md
...
from typing import (TypeVar, 
    ...
    SupportsFloat, SupportsIndex, SupportsInt, TextIO, Tuple, Type, Union,
    ValuesView)
...
def iter(collection: bytearray) -> Iterator[int]: ...
def iter(collection: str) -> Iterator[str]: ...
def iter(collection: list[_T]) -> Iterator[_T]: ...
...
def iter(func: typing.Callable[[], Union[_T, _T2]], sentinel: _T) -> Iterator[_T2]: ...
...
class bytearray(MutableSequence[int]):
    ...
    def istitle(self) -> bool: ...
    def isupper(self) -> bool: ...
    def join(self, iterable: Iterable[Union[bytes, bytearray]]) -> bytearray: ...
...
# "reversed" is a type, but we simplify it as function.
def reversed(sequence: Reversible[_T]) -> Iterator[_T]:...
...
class set(Set[_T]):
    ...
    @staticmethod
    @overload
    def union(*args: Iterable[_T]) -> set[_T]: ...
    @staticmethod
    @overload
    def union(*args, **kwargs) -> set[Any]: ...
    @staticmethod
    @overload
    def intersection(*args: Iterable[_T]) -> set[_T]: ...
    @staticmethod
    @overload
    def intersection(*args, **kwargs) -> set[Any]: ...
    @staticmethod
    @overload
    def difference(*args: Iterable[_T]) -> set[_T]: ...
    @staticmethod
    @overload
    def difference(*args, **kwargs) -> set[Any]: ...
    @staticmethod
    @overload
    def symmetric_difference(*args: Iterable[_T]) -> set[_T]: ...
    @staticmethod
    @overload
    def symmetric_difference(*args, **kwargs) -> set[Any]: ...
...
class frozenset(FrozenSet[_T]):
    ...
    def issuperset(self, y: Iterable) -> bool: ...
    @staticmethod
    def union(*args, **kwargs) -> frozenset[Any]: ...
    @staticmethod
    def intersection(*args, **kwargs) -> frozenset[Any]: ...
    @staticmethod
    def difference(*args, **kwargs) -> frozenset[Any]: ...
    @staticmethod
    def symmetric_difference(Iterable) -> frozenset[Any]: ...
...
class Sequence(Collection[_T], Reversible[_T], Protocol):
  __slots__ = []
  @abstractmethod
...
class IO(Iterator[AnyStr]):
  ...
  mode: str
  closed: bool
  newlines: Union[None, str, Tuple[str,...]]
...
class Mapping(Collection[_K], Generic[_K, _V], Protocol):
  __slots__ = []
...
class AbstractSet(Collection[_T]):
  __slots__ = []
  def __contains__(self, x) -> bool: ...
...
class Counter(Dict[_K, int]):
  __doc__: str
  @staticmethod
  def fromkeys(keys: Iterable[_K]) -> Counter[_K]: ...
  @staticmethod
  def fromkeys(keys: Iterable[_K], value: int) -> Counter[_K]: ...
